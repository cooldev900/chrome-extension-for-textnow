const Message = ({ setMessageTemplate }: { setMessageTemplate: (value: string) => void }) => {
    return <div className="w-full relative float-label-input">
        ...
        <label htmlFor="name" className="absolute top-3 left-0 text-gray-400 pointer-events-none transition duration-200 ease-in-outbg-white px-2 text-grey-darker transform -translate-y-6 scale-75 bg-white">Message Template</label>
    </div>
}
